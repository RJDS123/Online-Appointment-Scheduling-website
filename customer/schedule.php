 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session btn-hover menu-active menu-icon-session-active">
                ...
                <tr >
                    ...
                    <td >
                            <form action="" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Consultant name or Email or Date (YYYY-MM-DD)" list="doctors" value="<?php  echo $insertkey ?>">&nbsp;&nbsp;
                                    ...
                                    for($q=0;$q<3;$q++){
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%">
                                                            <div class="h1-search">
                                                            Session Name: &nbsp;   '.substr($title,0,21).'
                                                            </div><br>
                                                            <div class="h3-search">
                                                            Consultant Name:   '.substr($docname,0,30).'
                                                            </div>
                                                            <div class="h3-search">
